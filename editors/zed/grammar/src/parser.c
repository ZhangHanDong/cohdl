...
enum ts_symbol_identifiers {
  ...
  anon_sym_fn = 20,
  anon_sym_design = 21,
  anon_sym_subdesign = 22,
  anon_sym_footprint = 23,
  anon_sym_pad = 24,
  anon_sym_use = 25,
  anon_sym_impl = 26,
  anon_sym_for = 27,
  ...
  sym_source_file = 46,
  sym__node = 47,
  sym__keyword_fallback = 48,
  sym_declaration = 49,
  sym_use_declaration = 50,
  sym_impl_declaration = 51,
  sym_inst_statement = 52,
  sym_net_statement = 53,
  sym_pad_placement = 54,
  sym_path = 55,
  sym_attribute = 56,
  sym_block = 57,
  sym_parens = 58,
